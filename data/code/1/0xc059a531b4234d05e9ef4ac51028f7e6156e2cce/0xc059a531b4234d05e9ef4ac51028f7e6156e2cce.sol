...
abstract contract MemecoinDelegatableUpgradeable is ContextUpgradeable {
...
import {IMemecoinStaking} from "./interfaces/IMemecoinStaking.sol";
import {MemecoinDelegatableUpgradeable} from "contracts/memecoin/delegate/MemecoinDelegatableUpgradeable.sol";

contract MemecoinStaking is
    Initializable,
    UUPSUpgradeable,
...
interface IMemecoinStaking is IERC20TokenTracker {
    struct Reward {
        uint256 rewardId;
        uint256 amount;
        bytes32[] proof;
