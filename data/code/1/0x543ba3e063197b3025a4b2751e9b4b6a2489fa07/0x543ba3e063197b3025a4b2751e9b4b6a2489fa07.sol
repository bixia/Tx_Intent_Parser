...
contract MerkleDistributorWithDeadline is MerkleDistributor, Ownable {
    ...
    constructor(address token_, bytes32 merkleRoot_, uint256 endTime_) MerkleDistributor(token_, merkleRoot_) Ownable(msg.sender) {
...
import { MerkleDistributorWithDeadline } from "@uniswap/merkle-distributor/MerkleDistributorWithDeadline.sol";

contract PirateClaim is MerkleDistributorWithDeadline {
